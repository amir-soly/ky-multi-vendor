                ...
                <form id="seller_identity_form" class="hidden">
                    ...
                    <div class="flex-cb gap-4 mb-6">
                        <div class="w-full">
                            ...
                            <select name="birthday-day" id="birthday-day" class="border-lite-gray py-3 px-8 !rounded-2.5 w-full appearance-select">
                                <?php for ($i = 1; 32 > $i; $i++) { ?>
                        ...
                        <div class="w-full">
                            ...
                            <select name="birthday-month" id="birthday-month" class="border-lite-gray py-3 px-8 !rounded-2.5 w-full appearance-select">
                        ...
                        <div class="w-full">
                            ...
                            <select name="birthday-year" id="birthday-year" class="border-lite-gray py-3 px-8 !rounded-2.5 w-full appearance-select">
