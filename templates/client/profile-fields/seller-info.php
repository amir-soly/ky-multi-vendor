    ...
    <div class="grid grid-cols-2 gap-4 relative p-1">
        <div class="bg-back rounded-2.5 px-6 py-3">
            <div class="flex-cb">
                ...
                <button class="open-modal p-2" data-form="seller_name_form"><?= mv_get_seller_data($seller_id, 'seller_frist_name') ? $edit_svg : $add_svg; ?></button>
            </div>
        </div>
        <div class="bg-back rounded-2.5 px-6 py-3">
            <div class="flex-cb">
                ...
                <button class="open-modal p-2" data-form="seller_national_code_form"><?= mv_get_seller_data($seller_id, 'seller_national_code') ? $edit_svg : $add_svg; ?></button>
            </div>
        </div>
        <div class="bg-back rounded-2.5 px-6 py-3">
            <div class="flex-cb">
                <div>
                    ...
                    <p class="text-secondary text-base"><?= mv_get_seller_data($seller_id, 'seller_phone'); ?></p>
                </div>
                <button class="open-modal p-2" data-form="seller_phone_number_form"><?= mv_get_seller_data($seller_id, 'seller_phone') ? $edit_svg : $add_svg; ?></button>
            </div>
        </div>
        <div class="bg-back rounded-2.5 px-6 py-3">
            <div class="flex-cb">
        ...
        <div id="loader" class="transition-all absolute inset-0 w-full h-full backdrop-blur-sm flex-cc z-10 text-black opacity-0 invisible">
            <span><svg class="animate-spin mx-auto" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div id="modal-seller-info" class="transition-all z-50 fixed-center fixed w-full h-fit max-w-md max-lg:p-2 opacity-0 invisible">
            <div class="bg-white rounded-2.5 shadow-xl px-10 py-6 relative">
                <div class="flex-cb pb-3 border-b border-slate-300 mb-5">
                    ...
                    <button id="close-modal-seller-info"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                ...
                <form id="seller_name_form" class="hidden">
                    <div class="mb-6">
                        ...
                        <input type="text" name="seller_data" id="seller_first_name" value="<?= mv_get_seller_data($seller_id, 'seller_first_name'); ?>" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full">
                        <input type="hidden" name="meta_field" value="seller_first_name,seller_last_name">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="seller_data1" value="<?= mv_get_seller_data($seller_id, 'seller_last_name'); ?>" id="seller_last_name" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full">
                ...
                <form id="seller_national_code_form" class="hidden">
                    <div class="mb-6">
                        ...
                        <input type="text" inputmode="numeric" value="<?= mv_get_seller_data($seller_id, 'seller_national_code'); ?>" name="seller_data" id="seller_national_code" class="ltr border-lite-gray py-3 px-6 !rounded-2.5 w-full" pattern="[0-9]*">
                    </div>
                    <input type="hidden" name="meta_field" value="seller_national_code">
                    <input type="hidden" name="seller_id" value="<?php echo get_current_user_id(); ?>">
                    <button type="submit" class="!bg-primary !text-secondary block rounded-full py-3 px-20 font-bold mr-auto">تایید</button>
                </form>
