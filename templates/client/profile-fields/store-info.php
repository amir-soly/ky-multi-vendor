        ...
        <div class="bg-white rounded-2.5 shadow-xl px-10 py-6 relative">
            ...
            <form id="store_status_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="text" name="store_data" id="store_status" value="<?= mv_get_store_data($seller_id,'seller_status');?>" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full">
            ...
            <form id="store_name_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="text" name="store_data" value="<?= mv_get_store_data($seller_id,'store_name');?>" id="store_name" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full">
            ...
            <form id="store_about_form" class="hidden">
                <div class="mb-6">
                    ...
                    <textarea name="store_data" id="store_about" value="<?= mv_get_store_data($seller_id,'store_bio');?>" rows="4" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full"></textarea>
            ...
            <form id="store_landline_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="tel" inputmode="tel" name="store_data" value="<?= mv_get_store_data($seller_id,'store_phone');?>" id="store_landline" class="ltr border-lite-gray py-3 px-6 !rounded-2.5 w-full">
            ...
            <form id="store_website_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="url" inputmode="url" value="<?= mv_get_store_data($seller_id,'store_site');?>" name="store_data" id="store_website" class="ltr border-lite-gray py-3 px-6 !rounded-2.5 w-full">
            ...
            <form id="store_holidays_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="text" name="store_data" value="<?= mv_get_store_data($seller_id,'store_vacation');?>" id="store_holidays" class="border-lite-gray py-3 px-6 !rounded-2.5 w-full">
