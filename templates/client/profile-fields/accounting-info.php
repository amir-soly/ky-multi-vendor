...
<div class="grid grid-cols-2 gap-4 relative p-1">
    <div class="bg-back rounded-2.5 px-6 py-3">
        <div class="flex-cb">
            ...
            <button class="open-modal p-2" data-form="accounting_card_number_form"><?= mv_get_seller_data($seller_id, 'seller_accounting_card_number') ? $edit_svg : $add_svg; ?></button>
        </div>
    </div>
    <div class="bg-back rounded-2.5 px-6 py-3">
        <div class="flex-cb">
            <div>
                ...
                <p class="text-secondary text-base"><?= mv_get_seller_data($seller_id, 'seller_accounting_card_number') ? mv_get_seller_data($seller_id, 'seller_accounting_card_number') : '---'; ?></p>
            </div>
        ...
        <div class="bg-white rounded-2.5 shadow-xl px-10 py-6 relative">
            ...
            <form id="accounting_card_number_form" class="hidden">
                <div class="mb-6">
                    ...
                    <input type="text" inputmode="numeric" name="seller_accounting_card_number" id="accounting_card_number" class="ltr border-lite-gray py-3 px-6 !rounded-2.5 w-full" pattern="[0-9]{1,16}">
                </div>
            ...
            <form id="accounting_vat_exempt_form" class="hidden">
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-6">
                        <label><input type="radio" name="seller_vat_exempt" value="yes"> بله</label>
                        <label><input type="radio" name="seller_vat_exempt" value="no"> خیر</label>
                    </div>
                </div>
                <button type="submit" class="!bg-primary !text-secondary block rounded-full py-3 px-20 font-bold mr-auto">تایید</button>
            </form>
