...
if (isset($_GET['action']) && isset($_GET['mv_id'])) {
    if ($_GET['action'] == 'edit') {
        $mv_id = $_GET['mv_id'];
        $table_name = $wpdb->prefix . 'mv_seller_Sellers_data'; // نام جدول پیشفرض وردپرس
...
class MV_Sellers_List_Table extends WP_List_Table
{
    // تعیین ستون‌های جدول
    ...
    function show_Sellers_table()
    {
        ...
        echo '<li><a href="admin.php?page=mv-Sellers" class="' . $all_class . '">همه</a> | </li>';
        echo '<li><a href="admin.php?page=mv-Sellers&tab=published" class="' . $published_class . '">تایید شده</a> | </li>';
        echo '<li><a href="admin.php?page=mv-Sellers&tab=pending" class="' . $pending_class . '">در انتظار تایید</a> | </li>';
        echo '<li><a href="admin.php?page=mv-Sellers&tab=rejected" class="' . $rejected_class . '">رد شده</a></li>';
        echo '</ul>';
        ...
        $table = new MV_Sellers_List_Table();
        $table->prepare_items();
        $table->views();
